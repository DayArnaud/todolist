package com.dayanearnaud.todolist.task;
...
import com.dayanearnaud.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity<?> create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A data de início ou de término  deve ser maior do que a data atual");
        }
